...
- (void)setLocation:(CLLocation *)newLocation
{
    ...
    if ( _location && CLLocationCoordinate2DIsValid(_location.coordinate) && [newLocation distanceFromLocation:_location] == 0 && (newLocation.course < 0 || _location.course == newLocation.course)) return;
